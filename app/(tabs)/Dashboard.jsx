...
import RebarDetection from '../../src/components/BrickDetection';
...
const Dashboard = () => {
  ...
  const detectionOptions = [
    { 
      ...
      icon: <FontAwesome5 name="water" size={50} color="white" />, // Water pipe related
    ...
    { 
      ...
      icon: <FontAwesome5 name="th-large" size={50} color="white" />, // Represents bricks or blocks
    ...
    { 
      ...
      icon: <FontAwesome5 name="tools" size={50} color="white" />, // Related to construction
